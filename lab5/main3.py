...
def main():
  ...
  email_list, time_list, confidence_list = extractValues(lines)

  writeValuesToCsv(outputFilepath, email_list, time_list, confidence_list)

def writeValuesToCsv(filepath, email_list, time_list, confidence_list):
...
def extractValues(lines):
  ...
  return email_list, time_list, confidence_list
